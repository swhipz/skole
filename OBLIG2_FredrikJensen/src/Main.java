...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Planet planetListe = new Planet("Liste" + 1.0, 1,0);




        System.out.println(jorden.getPlanets().size());
        planetListe.getPlanets().add(new Planet("Jorden", 0.08911486599899289, 0.003146469968387777));
      ...
      //  solarSystem.getPlanets().add(new Planet("Merkur", 0.03412549655905556, 1.7297154899894627E-4));
        ...
        for (Planet xPlanet : planetListe.getPlanets()) {
